...
DefinabilityChecker::DefinabilityChecker( std::vector<int>& universal_variables, const std::vector<int>& existential_variables, 
                                          std::vector<Clause>& matrix, int& last_used_variable, bool compress) : 
                                          last_used_variable(last_used_variable), compress(compress) {
  backbone_solver = std::make_shared<CadicalSolver>();
  fast_solver = std::make_shared<CadicalSolver>();
...
DefinabilityChecker::DefinabilityChecker(DefinabilityChecker&& checker, int& last_used_variable) : 
      last_used_variable(last_used_variable), compress(checker.compress), 
